...
<head>
  ...
  <title>Marwari College - List Admin</title>
        ...
        <ul id="icons-nav" class="nav-content" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="list_admin.php">
              <i class="bi bi-circle"></i><span class="text-primary">List Admin</span>
            </a>
          </li>
        </ul>
      </li><!-- End Icons Nav -->
    ...
    <div class="card-body">
        ...
        <form method="post">   
            ...
            <div class="input-group">
                ...
                <input name="find" class="form-control border-secondary border-right-0 rounded-1" type="search" placeholder="Employee Id" id="example-search-input4">                   
                </div>
                ...
                if(isset($_POST['ok']))
                {
                    ...
                    <table class='table table-hover'>
                      ...
                      //admin list table                    
                          $sql="SELECT * FROM  `admin_login` WHERE emp_id='$_POST[find]'";
                          $result=$con->query($sql);///result set
                          if($result->num_rows>0)
                          {
                                      ...
                                      <tr>
                                          ...
                                          <td  style='overflow: hidden; text-overflow: ellipsis;'> <a href='display_admin.php?id=$row[id]'>".$row["emp_id"]."</a></td>
                                      </tr>
                                      ";
                                      $no++;
                                      }
