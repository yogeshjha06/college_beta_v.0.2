...
?> 
<!-- update student profile start link  -->
                </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form method="post">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="reg" type="text" class="form-control" id="reg" value="<?php echo $reg_id;?>" readonly/>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="exam" type="text" class="form-control" id="exam" value="<?php echo $exam_id;?>" readonly/>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="class" type="text" class="form-control" id="class" value="<?php echo $class_roll;?>" readonly/>
                      </div>
                    </div>
...
<form method="post">
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  <!-- Change Password Form -->
                    ...
                    <div class="text-center">                    
                      <button style="border-radius: 20px;" id='change' name="change"  class="btn btn-outline-primary" type="submit"><i class="bi bi-key-fill"></i>  Update Password</button>
                    </div>
