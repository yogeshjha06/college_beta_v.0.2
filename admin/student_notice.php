...
<a href="./dlocker.php">
  ...
  <a class="nav-link collapsed" href="student_library.php">
    ...
    <span>Athenaeum</span>
      ...
      <li class="nav-item">
        <a class="nav-link" href="student_notice.php">
    ...
    <div class="card-body">
        ...
        <form method="post">   
            ...
            <div class="input-group">
                ...
                border-bottom-left-radius: 20px;" name="find" class="form-control" type="search" placeholder="Find Notice" id="example-search-input4">                   
                </div>
                        ...
                        else
                        {
                            ...
                            <script>                
                                swal({
                                    ...
                                    window.location = 'student_notice.php';
                                    });                        
                                    </script>";
                        }
