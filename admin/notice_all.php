...
<head>
  ...
  <title>Marwari College - Notice Details</title>
    ...
    <div class="card-body">
        ...
        <form method="post">   
            ...
            <div class="input-group">
                ...
                <input name="find" class="form-control border-secondary border-right-0 rounded-1" type="search" placeholder="Find Notice" id="example-search-input4">                   
                </div>
                ...
                if(isset($_POST['ok']))
                {
                    ...
                    <table class='table table-hover'>
                      ...
                      //admin list table                    
                          $sql="SELECT * FROM  `db_notice` WHERE emp_id='$_POST[find]' OR subject='$_POST[find]' OR date='$_POST[find]'";
                          $result=$con->query($sql);
                          if($result->num_rows>0)
                          {
                                        ...
                                        <tr>
                                            ...
                                            <td  style='overflow: hidden; text-overflow: ellipsis;'>".$row["subject"]."</td>
                                            <td  style='word-wrap: break-word; overflow: hidden; text-overflow: ellipsis;'>".$row["date"]."</td>
                                            <td  style='overflow: hidden; text-overflow: ellipsis;'><a href='notice_1.php?id=$row[id]'>"."View"."</a></td>
                                        </tr>
                                        ";
                                        $no++;
                                        }
                        ...
                        else
                        {
                            ...
                            <script>                
                                swal({
                                    icon: 'info',
                                    title:'Failed',
                                    text: 'Unable To Find Notice!',
                                    }).then(function() {
                                    window.location = 'notice_all.php';
                                    });                        
                                    </script>";
                        }
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <center>
              <h5 class="card-title">All Notice Record List</h5>
              ...
              <table class="table table-hover">
                ...
                <?php
                //admin list table                    
                    $sql="SELECT * FROM  `db_notice` ORDER BY id DESC";
                    $result=$con->query($sql);
                    $no=1;
                    while($row=$result->fetch_assoc())
                    {
