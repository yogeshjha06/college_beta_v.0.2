...
<head>
  ...
  <title>Marwari College - Remove Student</title>
        ...
        <ul id="components-nav" class="nav-content" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="remove_student.php">
              <i class="bi bi-circle"></i><span class="text-primary">Remove Student</span>
            </a>
          </li>
            ...
            <div class="card-body">
             ...
             <form class="row g-3" method="post">
                ...
                <div class="col-md-12">
                  ...
                  <input name="name" type="text" class="form-control" id="name" placeholder="Student Name" autocomplete="off" required/>
                </div>
                <!-- employee id -->
                <div class="col-md-6">
                  <label for="reg_id" class="form-label">Regestration Number</label>
                ...
                <div class="text-center">
                  <button name="submit" style="border-radius: 20px; text-align: center;" type="submit" class="btn btn-outline-primary"><i class='bi bi-trash3'></i>   Remove </button>
...
<?php
              ...
              if(isset($_POST['submit']))
              {
                ...
                $user_stu=$_POST['username'];
                //check username email and emp_id
                $res=mysqli_query($con,"DELETE FROM `student_details` WHERE username='$user_stu' AND reg_id='$reg_stu' OR name='$name_stu'");
                if($res)
                    {
                        echo"<script>                
                            swal({
                                ...
                                text: 'Student Successfully Removed!',
                                    ...
                                    window.location = 'remove_student.php';
                                });                        
                                </script>";
                    }
                    else
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    echo"                                    
                      <a href='display_student.php?id=$row[id]' class='list-group-item list-group-item-action active' aria-current='true'>
                        ...
                        <p class='mb-1'> <b>Regestration No.     </b>".$row['reg_id']."</p>
