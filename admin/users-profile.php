...
else
{
    ...
    $rs1x = mysqli_fetch_array($queryx);
      ...
      $password=$rs1x['password'];//password of account
...
<head>
  ...
  <title>Marwari College - Admin Profile</title>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              border-width: 5px;
              border-color: #B6D0E2;
              "    src="./assets/images/profile.png" alt="Profile" class="rounded-circle">
              <h2><a href="#"><?php echo $name;?> <i style="max-height: 22px; width: 22px;" class="bi bi-patch-check-fill"></i></a></h2>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $emp_id;?></div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form method="post">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="dept" type="text" class="form-control" id="Country" value="<?php echo $department;?>">
                      </div>
                    </div>
...
{
  $res=mysqli_query($con,"UPDATE `admin_login` SET name = '$_POST[fullName]', about='$_POST[about]', 
  department='$_POST[dept]', address='$_POST[address]', phone='$_POST[phone]', email='$_POST[email]',
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form method="post" action="email1.php">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input id='oldp' name="password" type="password" class="form-control" >
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input id='newp' name="newpassword" type="password" class="form-control" >
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input id='rep' name="renewpassword" type="password" class="form-control"  onkeyup='check();'>
                      </div>
                    </div>
                    ...
                    <div class="text-center">
                      ...
                      <button style="border-radius: 20px;" id='change' name="change"  class="btn btn-outline-primary" type="submit"><i class="bi bi-key"></i>  Change Password</button>
                    </div>
