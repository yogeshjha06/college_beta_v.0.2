    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content" data-bs-parent="#sidebar-nav">
          <li>
            <a href="library.php">
              <i class="bi bi-circle"></i><span class="text-primary">Library</span>
            </a>
          </li>
          <li>
            <a href="add_book.php">
    ...
    <div class="card-body">
        ...
        <form method="post">   
            ...
            <div class="input-group">
                ...
                <input name="find" class="form-control border-secondary border-right-0 rounded-1" type="search" placeholder="Find Book" id="example-search-input4">                   
                </div>
                ...
                if(isset($_POST['ok']))
                {
                      ...
                      //admin list table                    
                          $sql="SELECT * FROM  `book_db` WHERE name='$_POST[find]'";
                          $result=$con->query($sql);
