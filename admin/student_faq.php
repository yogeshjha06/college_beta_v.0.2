...
<li class="nav-item">
  <a class="nav-link" href="student_faq.php">
    <i class="bi bi-question-circle"></i>
    <span class="text-primary">F.A.Q</span>
  </a>
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <strong>Student Portal is "Communicating Point".</strong> An Student Portal enables student's of our application  
                      system to manage their configurations, settings, content, and features and carry out oversight 
                      functions critical to the institution. It allows them to view the state of the platform and take any action in 
                      the performance. <br><code>Yogesh Kumar Jha</code>
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                      How to Creat Student Portal Account?
                    </button>
                  </h2>
                  <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <strong>Only an Admin can Add "New Student".</strong> To insure the security of our application we allow only restricted admin protocols. 
                      So to add a new student you must have a admin account, You can ask teacher's / staff to add you if not already.
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                      How to Find Friend's on Student Portal?
                    </button>
                  </h2>
                  <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    <strong>Looking for a new friend?..</strong> We got your back. Now student can log in to their account Search their friend name or their Regestration id or username to find them. 
                      You can personaly chat with them too. Which by the way we are not listning.
                      For student ike you we are always  dedicated to provide comfortable and safe environment. <br><code>Yogesh Kumar Jha</code>
                    </div>
                  </div>
                </div>
