...
<head>
  ...
  <title>Marwari College - Add Student</title>
        ...
        <ul id="components-nav" class="nav-content" data-bs-parent="#sidebar-nav">
          <li>
            <a href="add_student.php">
              <i class="bi bi-circle"></i><span class="text-primary">Add Student</span>
            </a>
          </li>
          <li>
            ...
            <div class="card-body">
             ...
             <form class="row g-3" method="post">
                ...
                <div class="col-md-6">
                  ...
                  <input name="name" type="text" class="form-control" id="name" placeholder="New Student Name" autocomplete="off" required/>
                </div>
                <!-- father name -->
                <div class="col-md-6">
                  <label for="fname" class="form-label">Parents Name</label>
                  <input name="fname" type="text" class="form-control" id="fname" placeholder="Father's/Mother's Name" autocomplete="off" required/>
                </div>
                <!-- regestration unique id -->
                <div class="col-md-6">
                  <label for="reg_id" class="form-label">Regestration No</label>
                  <input name="reg_id" type="text" class="form-control" id="reg_id" placeholder="Regestration Number" autocomplete="off" required/>
                </div>
                <!-- exam roll number -->
                <div class="col-md-6">
                  <label for="exam_id" class="form-label">Exam Roll No</label>
                  <input name="exam_id" type="text" class="form-control" id="exam_id" placeholder="Exam Roll Number" autocomplete="off" required/>
                </div>
              
                <!-- class roll number -->
                <div class="col-md-6">
                  <label for="class_roll" class="form-label">Class Roll</label>
                  <input name="class_roll" type="number"  class="form-control" id="class_roll" placeholder="Class Roll Number" autocomplete="off" required/>
                </div>
                <!-- department -->
                <div class="col-md-6">
                  <label for="department" class="form-label">department</label>
                  <input name="department" type="text" class="form-control" id="department" placeholder="Student Department" autocomplete="off" required/>
                </div>
                <!-- email -->
                <div class="col-md-6">
                  <label for="sem" class="form-label">Semester</label>
                  <input name="sem" type="number"  class="form-control" id="sem" placeholder="Student Semester" autocomplete="off" required/>
                </div>
                <!-- email -->
                <div class="col-md-6">
                  <label for="email" class="form-label">Email</label>
                  <input name="email" type="email" class="form-control" id="email" placeholder="Student Email" autocomplete="off" required/>
                </div>
                <!-- username of student  -->
                <div class="col-md-6">
                  <label for="username" class="form-label">Username</label>
                  <input name="username" type="text" class="form-control" id="username" placeholder="Class Roll Number" autocomplete="off" required/>
                </div>
                <!-- temp pasword  -->
                <div class="col-md-6">
                  <label for="password" class="form-label">password</label>
                  <input name="password" type="password" class="form-control" id="password" placeholder="Temporary Password" autocomplete="off" required/>
                </div>
...
<?php
              ...
              if(isset($_POST['submit']))
              {
                ...
                $stu_exam=$_POST['exam_id'];
                $stu_class=$_POST['class_roll'];
                ...
                $res=mysqli_query($con,"SELECT * FROM `student_details` WHERE username='$stu_username' AND reg_id='$stu_reg'");
                ...
                else
                {
                    ...
                    $date_now=date("Y-m-d");
                    //insert data query
                    $sql="INSERT INTO `student_details` (name, class_roll, reg_id, exam_id, department, username, password, email, date, father) VALUES ('$stu_name','$stu_class','$stu_reg','$stu_exam','$stu_department','$stu_username','$stu_password','$stu_email','$date_now','$stu_fname')";
                    $result=$con->query($sql);
                    if($result)
                    {
                        echo"<script>                
                        ...
                        echo"
                            <script>                
                                swal({
                                    icon: 'info',
                                    title:'Failed',
                                    text: 'Unable to add new student!',
                                    }).then(function() {
                                    window.location = 'add_student.php';
                                    });                        
                                    </script>";
...
?>
        ...
        <div class="card">
            <div class="card-body">
              <h5 class="card-title">Recently Added Student</h5>
