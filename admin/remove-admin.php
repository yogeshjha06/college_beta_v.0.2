...
<head>
  ...
  <title>Marwari College - Remove Admin</title>
        ...
        <ul id="icons-nav" class="nav-content" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="remove-admin.php">
              <i class="bi bi-circle"></i><span class="text-primary">Remove Admin</span>
            </a>
          </li>
          <li>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <center>
              <h5 class="card-title">Remove Admin</h5>
              </center>
             ...
             <form class="row g-3" method="post">
                ...
                <div class="col-md-12">
                  ...
                  <input name="name" type="text" class="form-control" id="name" placeholder="Admin Name" autocomplete="off" required/>
                </div>
                <!-- employee id -->
                <div class="col-md-6">
                  <label for="emp_id" class="form-label">Employee ID</label>
                  <input name="emp_id" type="text" class="form-control" id="emp_id" placeholder="Employee ID" autocomplete="off" required/>
                </div>
                <!-- username -->
                <div class="col-md-6">
...
<?php
              ...
              if(isset($_POST['submit']))
              {
                ...
                $res=mysqli_query($con,"DELETE FROM `admin_login` WHERE username='$admin_username' OR emp_id='$admin_emp' AND name='$admin_name'");
                if($res)
                    {
                        echo"<script>                
                            swal({
                                icon: 'success',
                                title: 'Success',
                                text: 'Admin Successfully Removed!',
                                }).then(function() {
                                    window.location = 'remove-admin.php';
                                });                        
                                </script>";
                    }
                    else
              ...
              if(isset($_POST['reset']))
              {
                ...
                header("location:remove-admin.php"); 
              }
?>
            </div>
          </div>
